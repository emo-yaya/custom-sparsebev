...
train_pipeline = [
    ...
    dict(type='Collect3D', keys=['img', 'voxel_semantics', 'voxel_instances', 'instance_class_ids', 'gt_bboxes_3d', 'gt_labels_3d',],  # other keys: 'mask_camera'
